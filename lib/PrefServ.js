...
exports.createPrefs = function() {
	...
	if (!(PrefServ.has('extensions.agentSpoof.disableRef')))

		//set referer pref
		PrefServ.set('extensions.agentSpoof.disableRef', false);
...
exports.resetPrefs = function() {
	...
	PrefServ.reset('extensions.agentSpoof.disableRef');
	...
	PrefServ.reset('network.http.referer.XOriginPolicy');
	PrefServ.reset('network.http.referer.trimmingPolicy');
	PrefServ.reset('network.http.referer.spoofSource');
